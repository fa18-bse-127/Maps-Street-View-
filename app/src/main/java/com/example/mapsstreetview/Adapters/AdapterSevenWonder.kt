...
class AdapterSevenWonder(val context: Context, private val mList: List<ItemsViewModel>) : RecyclerView.Adapter<AdapterSevenWonder.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.parent.setOnClickListener {
            val gmmIntentUri = Uri.parse("google.streetview:cbll=${ItemsViewModel.latLng.latitude},${ItemsViewModel.latLng.longitude}")
