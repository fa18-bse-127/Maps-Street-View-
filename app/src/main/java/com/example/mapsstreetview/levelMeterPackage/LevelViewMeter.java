...
public final class LevelViewMeter extends View {

	//region
	public LevelViewMeter(Context context) {
		super(context);
	}

	public LevelViewMeter(Context context, AttributeSet attrs) {
		super(context, attrs);
	}

	public LevelViewMeter(Context context, AttributeSet attrs, int defStyleAttr) {
		super(context, attrs, defStyleAttr);
	}

	public LevelViewMeter(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
